...
export default function Foods() {
  ...
  const addToCart = (food: Food) => {
    ...
    setFoods((prev) =>
      prev.map((f) =>
        f.id === food.id ? { ...f, foodAmount: f.foodAmount - 1 } : f,
      ),
    );
  };
  ...
  const removeItem = (id: number) => {
    ...
    setFoods((prev) =>
      prev.map((f) =>
        f.id === id ? { ...f, foodAmount: f.foodAmount + item.quantity } : f,
      ),
    );
  ...
  const increaseCart = (id: number) => {
    ...
    setFoods((prev) =>
      prev.map((f) =>
        f.id === id ? { ...f, foodAmount: f.foodAmount - 1 } : f,
      ),
    );
  };
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flex: 1, marginTop: 59 }}>
        <Sidebar />
        ...
        >
          <h2 style={{ marginBottom: "2vh" }}>เมนูอาหาร</h2>
                ...
                <div style={{ padding: 14 }}>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        background:
                          food.foodAmount === 0 || isInCart(food.id)
                            ? "#ccc"
                            : "#ff6600",
                        border: "none",
                        color: "white",
      ...
      >
        <FaShoppingCart
          fontSize="35px"
          style={{ backgroundColor: "#ffffff", color: "#ff6600" }}
        />
      </button>
